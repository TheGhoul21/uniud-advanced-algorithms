...
But is this correct? Or do we miss some potential matches by jumping directly to $s=8$ (Figure~\ref{fig:kmp-shift-idea})?
...
the next character of $T$ (see Figure~\ref{fig:ktree-scan}).
