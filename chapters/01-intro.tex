...
\begin{tikzpicture}[
  ...
  %% ── SHARED-PREFIX BRACE ──────────────────────────────────────
  % Highlight that "tatoo" and "theater" share the initial 't'
  \draw[blue!35, thick, decorate,
        decoration={brace, raise=4pt, amplitude=5pt}]
    (nTA.west |- nTATOO.south) -- (nTH.east |- nTATOO.south)
    node[midway, below=10pt, font=\tiny\sffamily, text=blue!55!black]
...
\begin{tikzpicture}[
  ...
  \draw[aeg] (root) -- (nM)
    node[midway, right, font=\tiny\ttfamily, text=violet!55!black] {$a_j$};
  \draw[aeg] (nM)   -- (nMa);
