...
\aside{The algorithm is named after Donald Knuth, James Morris, and
Vaughan Pratt, who discovered it independently around 1970.
Morris came up with the idea while writing a text editor; Knuth and Pratt
arrived at it through theoretical analysis.
...
\begin{tikzpicture}[
    ...
    \node[below=2pt of new, font=\tiny, text=orange!80!black] {single comparison};
\end{tikzpicture}
\end{center}
...
in 1975, and was originally built for \texttt{fgrep}, the Unix tool for
searching a file for multiple fixed strings at once --- so every time
you run \texttt{grep -F} with several patterns, you are using a direct
descendant of this construction.}
