...
\aside{This ``fall back to the prefix-suffix of the prefix-suffix'' is the recursive
heart of KMP --- the same shift logic used during search is used during preprocessing.}