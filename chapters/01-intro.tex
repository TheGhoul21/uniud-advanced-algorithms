...
\aside{Why learn Boyer-Moore if KMP already achieves $\Oh{n+m}$?
...
\draw[-Stealth, orange!50!black, thick, dashed]
  ({2*\cw}, 0.85) to[bend right=25] ({5*\cw}, 0.85);
\node[font=\scriptsize\sffamily, text=orange!60!black] at ({3.5*\cw}, 0.45)
...
\foreach \i/\c in {1/c, 2/b, 3/a, 4/c, 5/b, 6/a}
  \node[C] (R\i) at ({\i*\cw}, -0.8) {\c};
\foreach \i in {1,...,6}
  \node[font=\tiny\sffamily, text=gray!50, above=2pt] at ({\i*\cw}, -0.4) {\i};

% Highlight Z_4: prefix of P^r (positions 1..3 = cba) matches at position 4
\foreach \i/\c in {1/c, 2/b, 3/a}
  \node[Pf] at ({\i*\cw}, -0.8) {\c};
\foreach \i/\c in {4/c, 5/b, 6/a}
  \node[Zm] at ({\i*\cw}, -0.8) {\c};

% Brace under prefix
\draw[violet!50!black, thick, decorate,
      decoration={brace, mirror, raise=4pt, amplitude=4pt}]
  ({0.6*\cw}, -1.25) -- ({3.4*\cw}, -1.25)
  node[midway, below=10pt, font=\scriptsize\sffamily, text=violet!60!black]
    {prefix $P^r[1..3] = \texttt{cba}$};

% Brace under match
\draw[violet!50!black, thick, decorate,
      decoration={brace, mirror, raise=4pt, amplitude=4pt}]
  ({3.6*\cw}, -1.25) -- ({6.4*\cw}, -1.25)
  node[midway, below=10pt, font=\scriptsize\sffamily, text=violet!60!black]
    {$P^r[4..6] = \texttt{cba}$};

\draw[-Stealth, violet!50!black, thick, dashed]
  ({2*\cw}, -1.75) to[bend right=25] ({5*\cw}, -1.75);
\node[font=\scriptsize\sffamily, text=violet!60!black] at ({3.5*\cw}, -2.15)
...
\draw[<->, very thick, Stealth-Stealth, blue!50!black]
  ({7.2*\cw}, 1.8) -- ({7.2*\cw}, -0.8)
  node[midway, right=4pt, font=\small\sffamily, text=blue!50!black, align=left]
...
\def\cw{0.82}
\def\rsp{2.1}   % row spacing

% ── helper macro: draw a labelled P-bar of length 5 ───────────────
% args: y-offset, case label, highlight cells (list: index/style pairs)
...
\foreach \x/\s in {1/mch,2/mch,3/mch,4/skip,5/cur}
  \node[\s] at ({\x*\cw}, -0.4) {};
\node[lbl] at ({3*\cw}, -0.4) {$N_i$};
\node[lbl] at ({5*\cw}, -0.9) {$i$};
\draw[<->, blue!50, thick] ({1.5*\cw},-0.9) -- ({3.5*\cw},-0.9)
...
\foreach \x/\s in {1/cell,2/cell,3/mch,4/mch,5/cur}
  \node[\s] at ({\x*\cw}, {-\rsp-0.4}) {};
\node[lbl] at ({4.5*\cw}, {-\rsp-0.9}) {$w$};
\draw[<->, blue!50, thick] ({3.5*\cw},{-\rsp-0.9}) -- ({4.9*\cw},{-\rsp-0.9})
  node[midway, below, font=\tiny\sffamily] {$w < N_i$};
...
\foreach \x/\s in {1/cell,2/mch,3/mch,4/mch,5/cur}
  \node[\s] at ({\x*\cw}, {-2*\rsp-0.4}) {};
\draw[<->, green!55!black, thick] ({2.5*\cw},{-2*\rsp-0.9}) -- ({4.9*\cw},{-2*\rsp-0.9})
...
\foreach \x/\s in {1/mch,2/mch,3/mch,4/mch,5/cur}
  \node[\s] at ({\x*\cw}, {-3*\rsp-0.4}) {};
\draw[<->, green!55!black, thick] ({0.5*\cw},{-3*\rsp-0.9}) -- ({4.9*\cw},{-3*\rsp-0.9})
